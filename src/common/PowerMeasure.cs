...
namespace common
{
    public class PowerMeasure
    {
        ...
        public decimal? ConsumedEnergyTotal { get; set; }
        ...
        public decimal? InjectedEnergyLowTarif { get; set; }
        public decimal? InjectedEnergyHighTarif { get; set; }
    ...
    {
        [JsonProperty("samplingdate")] public string SamplingDateString => Sampling.ToString();
